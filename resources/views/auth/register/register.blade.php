    ...
    <div class="w-100 vh-100 d-flex" style="align-items:center; justify-content:center;background: #ECF1F6;">
      ...
      <div class="w-25 vh-75 border form_register" style="background: white;font-weight: bold; padding:50px;">
        ...
        <div class="mt-3">
          ...
          <div style="display: flex;" class="select">
            <div style="width:30%; text-align: center;" class="border-primary border-bottom border-primary">
            ...
            <label style="font-size:13px width:5%;">年</label>
            <div style="width:30%; text-align: center;" class="border-bottom border-primary">
            ...
            <label style="font-size:13px width:5%;">月</label>
            <div style="width:30%; text-align: center;" class="border-bottom border-primary">
            ...
            <label style="font-size:13px width:5%;">日</label>
          </div>
        </div>
        <div class="mt-3">
          @error('role')
        ...
        <div class="mt-3">
          ...
          <div class="border-bottom border-primary">
            <input type="password" class="border-0 w-100 password_confirmation" name="password_confirmation"> <!-- nameを変更 -->
          </div>
        </div>
